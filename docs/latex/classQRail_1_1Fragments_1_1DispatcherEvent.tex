...
Events are dispatched using the Qt event system. Each event is encapsulated in a \mbox{\hyperlink{classQRail_1_1Fragments_1_1DispatcherEvent}{Dispatcher\+Event}} with its own properties. 
