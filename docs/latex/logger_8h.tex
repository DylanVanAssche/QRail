...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{logger_8h_ad1cb0381c7ff42a54e3dce226f28fd4b}{handler}} (Qt\+Msg\+Type type, const Q\+Message\+Log\+Context \&\mbox{\hyperlink{qrail_8cpp_ae47df9f0f42cae4334448ab57992368e}{context}}, const Q\+String \&msg)
\item 
...
\index{logger.h@{logger.h}!LINE\_LENGTH@{LINE\_LENGTH}}
\index{LINE\_LENGTH@{LINE\_LENGTH}!logger.h@{logger.h}}
...
\index{logger.h@{logger.h}!enableLogger@{enableLogger}}
\index{enableLogger@{enableLogger}!logger.h@{logger.h}}
\subsubsection{\texorpdfstring{enableLogger()}{enableLogger()}}
...
\index{logger.h@{logger.h}!clearLog@{clearLog}}
\index{clearLog@{clearLog}!logger.h@{logger.h}}
...
\index{logger.h@{logger.h}!compileDate@{compileDate}}
\index{compileDate@{compileDate}!logger.h@{logger.h}}
\subsubsection{\texorpdfstring{compileDate}{compileDate}}
...
\index{logger.h@{logger.h}!compileTime@{compileTime}}
\index{compileTime@{compileTime}!logger.h@{logger.h}}
\subsubsection{\texorpdfstring{compileTime}{compileTime}}
