...
private:
    ...
    QList<RouterEngine::Route *> m_routes;
    QMap<QUrl, QList<RouterEngine::StationStopProfile *> > m_SArray;
    QMap<QUrl, RouterEngine::TrainProfile *> m_TArray;
    ...
    QList<RouterEngine::Route *> routes() const;
    void setRoutes(const QList<RouterEngine::Route *> &routes);
    QMap<QUrl, QList<RouterEngine::StationStopProfile *> > SArray() const;
    void setSArray(const QMap<QUrl, QList<RouterEngine::StationStopProfile *> > &SArray);
    QMap<QUrl, RouterEngine::TrainProfile *> TArray() const;
    void setTArray(const QMap<QUrl, RouterEngine::TrainProfile *> &TArray);
