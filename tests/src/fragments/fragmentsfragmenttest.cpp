...
/*
 * Based on iRail graph from
 * https://graph.irail.be/sncb/connections?departureTime=2018-07-21T07:29:00.000Z
 * If no delays are encountered for a connection, those fields are not
 * available. When there's a delay, the gtfs:pickupType and gtfs:dropOffType
