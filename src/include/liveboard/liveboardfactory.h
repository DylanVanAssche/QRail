...
class Factory : public QObject
{
    Q_OBJECT
public:
    static Liveboard::Factory *getInstance();
    void getLiveboardByStationURI(
            const QUrl &uri,
            const Liveboard::Board::Mode &mode = Liveboard::Board::Mode::DEPARTURES
            );
    void getLiveboardByStationURI(
            const QUrl &uri,
    ...
    Liveboard::Board *liveboard() const;

signals:
    void liveboardReady(Liveboard::Board *liveboard);
    void fromChanged();
    void untilChanged();
...
private:
    ...
    Liveboard::Board *m_liveboard;
    QDateTime m_from;
    QDateTime m_until;
    QUrl m_stationURI;
    Liveboard::Board::Mode m_mode;
    static Liveboard::Factory *m_instance;
    ...
    void setLiveboard(Liveboard::Board *liveboard);
