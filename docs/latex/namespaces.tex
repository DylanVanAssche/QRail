...
\item\contentsline{section}{\mbox{\hyperlink{namespaceAlertsEngine}{Alerts\+Engine}} \\*Constructs a Message to store the information about a disturbance, remark or anything else that might be usefull for the user }{\pageref{namespaceAlertsEngine}}{}
