...
\begin{DoxyCompactList}\small\item\em Constructs a Message to store the information about a disturbance, remark or anything else that might be usefull for the user. \end{DoxyCompactList}\end{DoxyCompactItemize}
